...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    const thisVar = new DataAwsAmi(this, "this", {
      filter: [
        {
          name: "architecture",
          values: ["arm64"],
    ...
    awsInstanceThis.overrideLogicalId("this");
  }
}
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    const myVpc = new Vpc(this, "my_vpc", {
      cidrBlock: "172.16.0.0/16",
      tags: {
        Name: "tf-example",
      },
    });
    const mySubnet = new Subnet(this, "my_subnet", {
    ...
    const foo = new NetworkInterface(this, "foo", {
    ...
    const awsInstanceFoo = new Instance(this, "foo_3", {
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    ...
    const awsInstanceExample = new Instance(this, "example_3", {
...
* `volumeType` - (Optional) Type of volume. Valid values include `standard`, `gp2`, `gp3`, `io1`, `io2`, `sc1`, or `st1`. Defaults to the volume type that the AMI uses.
...
<!-- cache-key: cdktf-0.20.1 input-d8aa866ec3601422cc3ea4b6b03fbc6280e94e6d9ff5385f91123e703b1dc79b -->